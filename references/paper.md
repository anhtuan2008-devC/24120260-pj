...
4. Sử dụng codespaces tạo frontend mặc định với React Typescript. Sửa trang chủ sao cho có thể thực hiện các công việc bên dưới (khuyến khích sử dụng AI)

a. Xem danh sách nhân viên (ảnh phải hiển thị ảnh, ngày tháng năm tạo ra phải format theo định dạng dd/MM/yyyy

b. Xóa một nhân viên được chọn

c. Cập nhật thông tin một nhân viên (sửa tên).